  ...
  return (
    <div>
        <div className='Postpost'>
          <p className='headerpost'><MdOutlineMessage/>Post in your class</p>
          <div className='bodypost'>
            <img src='https://prod.flat-cdn.com/img/avatars/default.png' alt='userlogo'/>
            <textarea id="textareamsg" placeholder='Write a message to your class'></textarea>
          </div>
          <div className='footerpost'>
              <div className='buttonsfooter'>
                <button> <IoMdLink/>Add link</button>
                <button><GiMusicalScore/>Add score</button>
              </div>
          </div>
